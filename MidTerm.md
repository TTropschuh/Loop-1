...
Here I tried to combine those two sketches and put the for loop from the sketch before into the "Points" Class. But when I run it the translate command makes things weird.
